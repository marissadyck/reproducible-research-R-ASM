...
### 4. Recommended workflow for creating a new project 
...
1.  Create a new repository on github and when asked, go ahead an initialize the repository with a README file.
2.  Copy a clone of the repository from github
3.  Create a new RStudio project, but choose "from version control" when setting up the project.

### 5. Recommended workflow for cloning someone else's project

Cloning someone else's project is almost the same thing as creating a new project in RStudio! The only difference is that the repository you will copy from github will not be yours - you will copy it the same way as you would your own repository. After you have copied the repository, the steps for adding it as your own project are the same as for creating a new project.

### 6. Let's try it - using git and github commands in the terminal
...
| `git config credential.helper store` | For PC users, bypasses need to authenticate every time you pull/push/fetch etc. |
